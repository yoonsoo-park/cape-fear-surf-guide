...
def explain_live_record_with_agent(record: RecommendationRecord, model: Model) -> LiveAgentPlanningResult:
...
def plan_live_with_agent(
    ...
    **kwargs: Any,
    ...
    return explain_live_record_with_agent(planned.record, model)
